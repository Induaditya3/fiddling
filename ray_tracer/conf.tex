...
\section{Example scene with output}
Here, we define four spheres : three equally sized and one giant one . We also utilise three kinds of light: point source, directional and ambient. Output image is displayed in Fig.~\ref{output}. Some other scenes rendered using our ray tracer is given in  Fig.~\ref{demo1}, Fig.~\ref{demo2}, Fig.~\ref{demo3} and Fig.~\ref{demo4}.
...
\bibitem{r1} P. J. Schneider and D. H. Eberly, ``Geometric tools for computer graphics,'' Morgan Kaufmann Publishers, 2003.

\bibitem{r2} P. S. Strauss, ``A realistic lighting model for computer animators,'' IEEE Comput. Graph. Appl., 1990.

\bibitem{r3} B. T. Phong, ``Illumination for computer generated pictures,'' Commun. ACM, 1975.

\bibitem{r4} J. Hultquist, ``Intersection of a ray with a sphere,'' in Graphics Gems, A. S. Glassner, Ed., Academic Press Professional, 1990.

\bibitem{r5} R. Hall, ``Illumination and color in computer generated imagery,'' Springer-Verlag New York, 1989.

\bibitem{r6} T. Akenine-Möller, E. Haines, and N. Hoffman, ``Real-time rendering,'' A K Peters, Ltd., 2008.
